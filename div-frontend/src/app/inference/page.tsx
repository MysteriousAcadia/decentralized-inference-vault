                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Submit requests to your connected AI models
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-start">
                      <div className="bg-white border border-gray-200 rounded-lg px-4 py-2 max-w-md">
                        ...
                        <p>
                          Decentralized AI offers several key benefits: 1)
                          Eliminates single points of failure, 2) Reduces costs
                          through competition, 3) Prevents censorship, 4)
                          Enables data sovereignty, and 5) Creates new economic
                          models for AI model owners.
                        </p>
                      </div>
                    </div>
