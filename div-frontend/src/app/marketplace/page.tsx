  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Featured Models */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Featured Models</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockModels.filter(model => model.featured).map((model) => (
...
function ModelCard({ model, featured = false }: { model: any; featured?: boolean }) {
  return (
    <div className={`bg-white rounded-xl shadow-lg border ${featured ? 'border-indigo-200 ring-2 ring-indigo-100' : 'border-gray-200'} hover:shadow-xl transition-shadow`}>
      {featured && (
      ...
      <div className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-semibold text-green-600">${model.price} USDC</span>
          </div>
