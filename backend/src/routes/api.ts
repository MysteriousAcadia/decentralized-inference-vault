...
import { authenticateWallet, authenticateWalletHeader, optionalAuth, generateAuthMessage, AuthenticatedRequest } from '../middleware/auth.js';
...
router.get('/auth/message', [
  ...
  try {
    ...
    const message = generateAuthMessage(address as string, timestamp);
 ...
 */
router.post('/access/check', authenticateWallet, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
], handleValidationErrors, optionalAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
], handleValidationErrors, authenticateWallet, async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.post('/user/daos', authenticateWallet, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userAddress = req.user!.address;
 ...
 */
router.get('/file/serve/:fileName', authenticateWalletHeader, async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
router.get('/files/downloaded', authenticateWalletHeader, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userAddress = req.user!.address;
 ...
 */
router.delete('/file/:fileName', authenticateWallet, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { fileName } = req.params;
    const userAddress = req.user!.address;
